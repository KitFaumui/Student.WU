...
class Student:
    ...
    all_students = [] # class attribbute store all instances of the class
    ...
    def from_fullname(cls, full_name, grade, student_id):
        firstname, lastname = full_name.split() # "Kitiona Faumui" first Kitiona second Faumui
    ...
    def __str__(self):
        # Magic method __str__ is a user friendly representaion of the object
